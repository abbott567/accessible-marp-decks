...
Uses Node.js 24 (LTS), pinned in `.nvmrc` — `nvm use` (or fnm/asdf) picks it up automatically.
...
| `npm run coverage` | Runs the suite enforcing 100% line/branch/function coverage. |
